...
const createScene = async function () {
    ...
    /*-- CROUCHING APHRODITE --*/
    const aphrodite = await BABYLON.SceneLoader.ImportMeshAsync("", "./meshes", "aphrodite_crouching_british_museum.glb").then((result) => {
    ...
    /*-- BUST OF ZEUS --*/
    const zeus = await BABYLON.SceneLoader.ImportMeshAsync("", "./meshes", "colossal_marble_bust_of_zeus.glb").then((result) => {
    ...
    /*-- NIKE STATUE --*/
    const nike = await BABYLON.SceneLoader.ImportMeshAsync("", "./meshes", "nike_of_samothrace.glb").then((result) => {
